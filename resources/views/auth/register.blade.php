                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="p-2">
                                   ...
                                   <x-jet-input-error for="email"></x-jet-input-error>
                                        ...
                                        <div class="mt-3">
                                            <button class="btn btn-primary btn-block waves-effect waves-light" name = "submit" type="submit">Register</button>
                                        </div>

                                        <div class="mt-4 text-center">
                                            <p class="mb-0">By registering you agree to the SQLEye <a href="#"
                        ...
                        <div class="mt-5 text-center">
                            ...
                            <div>
                                <p>Already have an account ? <a  href="{{ route('login') }}" class="font-weight-medium text-primary">
                                        Login</a> </p>
                                <p>© 2020 SQLEye. Crafted with <i class="mdi mdi-heart text-danger"></i> by SQLEye</p>
                            </div>
                        </div>
